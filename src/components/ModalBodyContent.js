...
import BarsBottom from "./graphs/BarsBottom";
                        ...
                        <div className="data-vis col-lg-6">
                            <div className="row">
                                ...
                                <div className="profile-features col-6">
                                    <h5>Profile features</h5> </div>
                                <div className="languge-features col-6">
                                    <h5>Language features</h5> </div>
                                <div className="profile-features col-6">
                                ...
                                <div className="common-topics-from-tweets col-12">
                                    ...
                                    {bottomBarsWidth && <BarsBottom width={bottomBarsWidth} data={data.common_topic} />}
